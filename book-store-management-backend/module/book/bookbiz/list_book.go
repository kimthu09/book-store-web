...
type ListBookRepo interface {
	ListBook(ctx context.Context, filter *bookmodel.Filter, paging *common.Paging) ([]bookmodel.Book, error)
}
...
func (biz *listBookBiz) ListBook(ctx context.Context, filter *bookmodel.Filter, paging *common.Paging) ([]bookmodel.Book, error) {
